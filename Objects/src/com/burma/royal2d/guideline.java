...
public class guideline extends Activity implements B4AActivity{
	public static guideline mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.burma.royal2d", "com.burma.royal2d.guideline");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (guideline).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.burma.royal2d", "com.burma.royal2d.guideline");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.burma.royal2d.guideline", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (guideline) Create " + (isFirst ? "(first time)" : "") + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (guideline) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (guideline) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (guideline) Pause event (activity is not paused). **");
        if (mostCurrent != null)
...
mostCurrent._mycode._setnavigationcolor /*String*/ (mostCurrent.activityBA);
 //BA.debugLineNum = 17;BA.debugLine="Dim appbar As Panel = mycode.appbar(\"လမ်းညွှန်ချက";
_appbar = new anywheresoftware.b4a.objects.PanelWrapper();
_appbar = mostCurrent._mycode._appbar /*anywheresoftware.b4a.objects.PanelWrapper*/ (mostCurrent.activityBA,"လမ်းညွှန်ချက်",anywheresoftware.b4a.keywords.Common.False);
...
mostCurrent._activity.AddView((android.view.View)(_appbar.getObject()),(int) (0),mostCurrent._mycode._appbartop /*int*/ ,anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),mostCurrent._mycode._appbarheight /*int*/ );
 //BA.debugLineNum = 19;BA.debugLine="scv.Initialize(1000dip)";
mostCurrent._scv.Initialize(mostCurrent.activityBA,anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (1000)));
 //BA.debugLineNum = 20;BA.debugLine="Activity.AddView(scv,0,mycode.appbarheight,100%x,";
...
_lb = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 22;BA.debugLine="lb.Initialize(\"\")";
_lb.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 23;BA.debugLine="scv.Panel.AddView(lb,0,10dip,100%x,20dip)";
mostCurrent._scv.getPanel().AddView((android.view.View)(_lb.getObject()),(int) (0),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (20)));
 //BA.debugLineNum = 24;BA.debugLine="If gl <> \"\" Or gl = \"null\" Then";
if ((_gl).equals("") == false || (_gl).equals("null")) { 
 //BA.debugLineNum = 25;BA.debugLine="lb.Text = \"လမ်းညွှန်ချက် မရှိသေးပါ\"";
_lb.setText(BA.ObjectToCharSequence("လမ်းညွှန်ချက် မရှိသေးပါ"));
 }else {
 //BA.debugLineNum = 27;BA.debugLine="lb.Text=gl";
_lb.setText(BA.ObjectToCharSequence(_gl));
 };
 //BA.debugLineNum = 29;BA.debugLine="lb.Typeface = mycode.mmfont";
_lb.setTypeface((android.graphics.Typeface)(mostCurrent._mycode._mmfont /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject()));
 //BA.debugLineNum = 30;BA.debugLine="lb.TextSize = mycode.textsize(10)";
_lb.setTextSize(mostCurrent._mycode._textsize /*float*/ (mostCurrent.activityBA,(int) (10)));
 //BA.debugLineNum = 31;BA.debugLine="lb.TextColor=Colors.White";
...
_su = new anywheresoftware.b4a.objects.StringUtils();
 //BA.debugLineNum = 34;BA.debugLine="lb.Height = su.MeasureMultilineTextHeight(lb,lb.t";
_lb.setHeight(_su.MeasureMultilineTextHeight((android.widget.TextView)(_lb.getObject()),BA.ObjectToCharSequence(_lb.getText())));
 //BA.debugLineNum = 35;BA.debugLine="scv.Panel.Height = lb.Height+lb.Top+10dip";
mostCurrent._scv.getPanel().setHeight((int) (_lb.getHeight()+_lb.getTop()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10))));
...
public static String  _backbtn_click() throws Exception{
 //BA.debugLineNum = 44;BA.debugLine="Sub backbtn_click";
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 11;BA.debugLine="Dim scv As ScrollView";
...
public static String  _process_globals() throws Exception{
 ...
 //BA.debugLineNum = 7;BA.debugLine="Dim gl As String";
_gl = "";
